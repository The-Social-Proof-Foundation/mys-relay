...
use crate::Verifier;
use mys_types::MultisigAggregatedSignature;
use mys_types::MultisigCommittee;
use mys_types::MultisigMemberPublicKey;
use mys_types::MultisigMemberSignature;
...
impl MultisigAggregator {
    pub fn new_with_transaction(
        committee: MultisigCommittee,
        transaction: &mys_types::Transaction,
    ) -> Self {
        Self {
            committee,
    ...
    pub fn new_with_message(
        committee: MultisigCommittee,
        message: &mys_types::PersonalMessage<'_>,
    ) -> Self {
        Self {
            committee,
            signatures: Default::default(),
