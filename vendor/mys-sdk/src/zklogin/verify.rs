...
use mys_types::Bn254FieldElement;
use mys_types::CircomG1;
use mys_types::CircomG2;
use mys_types::Ed25519PublicKey;
use mys_types::Jwk;
use mys_types::Secp256k1PublicKey;
use mys_types::Secp256r1PublicKey;
use mys_types::SimpleSignature;
use mys_types::ZkLoginInputs;
use mys_types::ZkLoginProof;
...
mod test {
    use super::*;
    use mys_types::Ed25519Signature;
